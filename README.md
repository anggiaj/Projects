...
[**Fibonacci Sequence**](https://github.com/anggiaj/Projects/blob/master/Numbers/fibonacci.go) - Enter a number and have the program generate the Fibonacci sequence to that number or to the Nth number.

**Prime Factorization** - Have the user enter a number and find all Prime Factors (if there are any) and display them.

**Next Prime Number** - Have the program find prime numbers until the user chooses to stop asking for the next one.

[**Find Cost of Tile to Cover W x H Floor**](https://github.com/anggiaj/Projects/blob/master/Numbers/tileCost.go) - Calculate the total cost of tile it would take to cover a floor plan of width and height, using a cost entered by the user.
...
[**Collatz Conjecture**](https://github.com/anggiaj/Projects/blob/master/Classic%20Algorithms/collatz.go) - Start with a number *n > 1*. Find the number of steps it takes to reach one using the following process: If *n* is even, divide it by 2. If *n* is odd, multiply it by 3 and add 1.
...
[**Reverse a String**](https://github.com/anggiaj/Projects/blob/master/Text/reverse.go) - Enter a string and the program will reverse it and print it out.

[**Pig Latin**](https://github.com/anggiaj/Projects/blob/master/Text/piglatin.go) - Pig Latin is a game of alterations played on the English language game. To create the Pig Latin form of an English word the initial consonant sound is transposed to the end of the word and an ay is affixed (Ex.: "banana" would yield anana-bay). Read Wikipedia for more information on rules.

[**Count Vowels**](https://github.com/anggiaj/Projects/blob/master/Text/countVowels.go) - Enter a string and the program counts the number of vowels in the text. For added complexity have it report a sum of each vowel found.

[**Check if Palindrome**](https://github.com/anggiaj/Projects/blob/master/Text/palindrome.go) - Checks if the string entered by the user is a palindrome. That is that it reads the same forwards as backwards like “racecar”

[**Count Words in a String**](https://github.com/anggiaj/Projects/blob/master/Text/countWords.go) - Counts the number of individual words in a string. For added complexity read these strings in from a text file and generate a summary.
...
[**Quote Tracker (market symbols etc)**](https://github.com/anggiaj/Projects/blob/master/Text/quoteTracker.go) - A program which can go out and check the current value of stocks for a list of symbols entered by the user. The user can set how often the stocks are checked. For CLI, show whether the stock has moved up or down. *Optional: If GUI, the program can show green up and red down arrows to show which direction the stock value has moved.*
...
[**Whois Search Tool**](https://github.com/anggiaj/Projects/blob/master/Networking/whois.go) - Enter an IP or host address and have it look it up through whois and return the results to you.
...
[**Get Atomic Time from Internet Clock**](https://github.com/anggiaj/Projects/blob/master/Web/time.go) - This program will get the true atomic time from an atomic time clock on the Internet. Use any one of the atomic clocks returned by a simple Google search.
